...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          title: "PUBLICATIONS",
          description: "publications involved by Shuheng Chen",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-i-got-my-m-s-degree-and-graduated-from-usc",
          title: 'I got my M.S. degree and graduated from USC!',
          description: "",
          section: "News",},{id: "projects-youtube-crawler",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/al-folio/assets/pdf/Academic_Resume_ShuhengChen_LastUpdated_11242025.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%63%68%65%6E%31%31@%77%70%69.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=7jKYmkMAAAAJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/shuheng-chen-0aa196325", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Cryo3978", "_blank");
        },
      },{
      id: 'light-theme',
